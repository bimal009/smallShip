...
import { Activity, AppWindow, BookOpen, CircleHelp, CreditCard, Globe, KeyRound, LayoutDashboard, LogOut, PanelLeftClose, PanelLeftOpen, Rocket, Search, Settings } from "lucide-react";
...
const groups: NavGroupData[] = [
  ...
  { heading: "Developers", items: [
    { id: "keys", title: "API keys", icon: KeyRound, href: "/dashboard/keys" },
