...
7. Through the command tools, review git status and git diff, stage the intended changes, commit with a descriptive message, and push to the app's configured branch. Do not commit secrets or unrelated files. Verify each command succeeds before reporting completion.
